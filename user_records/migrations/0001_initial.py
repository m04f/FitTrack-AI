    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('plan', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, to='user_records.userplan')),
                ('planday', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, to='workout.planworkout')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
